...
class beauty(models.Model):
    ...
    address_web = models.URLField(max_length=200, blank=True, verbose_name='网址')
    ...
    liker = models.ManyToManyField('auth.User', blank=True, related_name = "like_by")
...
class beauty_local(models.Model):
    ...
    liker = models.ManyToManyField('auth.User', blank=True, related_name = "local_like_by")
    is_delete = models.BooleanField(default=False)
    def delete(self):
        self.is_delete=True
        self.save()
